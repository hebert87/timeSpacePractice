...
public class Practice {
  ...
  // Time Complexity: O(n)
  // Space Complexity: O(n)
  // Remember to define your variables! n = n*n
  ...
  // Time Complexity: O(1)
  // Space Complexity: O(1)
  // Remember to define your variables! n does not exist
  ...
  // Remember to define your variables! r= rows c=cols
  ...
  // Remember to define your variables! n = strs.length m = str.legnth()
  ...
  public static int mostCommonTimeEfficient(int[] nums) {
   ...
   int maxCount = 0;
   int mostCommon = 0;
    for(Integer number : intMap.keySet()) {
      if(intMap.get(number) > maxCount) {
        maxCount = intMap.get(number);
        mostCommon = number;
      }
    }
    return mostCommon;
